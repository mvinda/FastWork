package com.example.fastwork.utils.sp;
...
/**
 * Created by weihuada on 2018/4/7.
 * <p>
 * SharePreference工具类
 */
public class SharePreferenceUtil {
    ...
    /**
     * 将key-value放入SharePreference (默认是异步的 apply) (仅支持int ,long , boolean ,float, String, Set<String>)
     *
     * @param resId 键
     * @param value 值
     */
    ...
    /**
     * 将key-value放入SharePreference (仅支持int ,long , boolean ,float, String, Set<String>)
     *
     * @param key    键
     * @param value  值
     * @param isSync 是否同步运行
