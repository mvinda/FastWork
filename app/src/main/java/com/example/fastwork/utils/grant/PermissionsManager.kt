...
class PermissionsManager private constructor() {
     ...
     * are not always sure will be valid or not (e.g. open() from Fragment).
     *
     ...
     * that you are not always sure will be valid or not (e.g. open() from Fragment).
     *
     * @param context     the Context necessary to check the permission
     ...
     * This is only nullable as a courtesy for Fragments where open() may yeild null
