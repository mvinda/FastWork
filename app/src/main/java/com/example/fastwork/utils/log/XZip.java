...
public class XZip {
    ...
    public static void unZipFolder(String zipFileString, String outPathString) throws Exception {
        //android.util.Log.i( "xwidget"  , "UnZipFolder from= " + zipFileString  + "   To= "  + outPathString);
        ...
        while ((zipEntry = inZip.getNextEntry()) != null) {
            ...
            if (zipEntry.isDirectory()) {
                ...
                folder.mkdirs();
                //android.util.Log.i( "xwidget"  , "UnZip Folder= "+ folder.getPath());
                ...
                while ((len = inZip.read(buffer)) != -1) {
                    // write (len) byte from buffer at the mPosition 0
                    out.write(buffer, 0, len);
                    out.flush();
                }
                out.close();
                //android.util.Log.i( "xwidget"  , "UnZip file= "+ file.getPath());
    ...
    public static void zipFolder(String srcFileString, String zipFileString) throws Exception {
        zipFolder(new File(srcFileString), new File(zipFileString));

    }//end of func

    public static void zipFolder(File src, File zipFile) throws Exception {
        ...
        //压缩
        zipFiles(src.getParent() + File.separator, src.getName(), outZip);
